const rock_user = document.getElementById('rock-human');
const paper_user = document.getElementById('paper-human');
const scissors_user = document.getElementById('scissors-human');
